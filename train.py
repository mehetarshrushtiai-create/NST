...
def parse_arguments():
    ...
    parser.add_argument('--content_dir', type=str, default='C:\\Users\\shrus\\OneDrive\\Desktop\\NST_CODE\\content_data',
                        help='Location of content dataset')
    parser.add_argument('--style_dir', type=str, default='C:\\Users\\shrus\\OneDrive\\Desktop\\NST_CODE\\style_data',
                        help='Location of style dataset')
    parser.add_argument('--vgg', type=str, default='C:\\Users\\shrus\\OneDrive\\Desktop\\NST_CODE\\vgg_normalised.pth',
...
def main():
    ...
    for epoch in range(args.epochs):
        ...
        if (epoch + 1) % args.save_interval == 0:
            ...
            print(f'Saved decoder and optimizer checkpoints at epoch {epoch+1}')
        with torch.no_grad():
            output = torch.cat([content_batch, style_batch, g], dim=0)
            save_image(output, save_dir / f'output_epoch_{epoch+1}.png', nrow=args.batch_size, normalize=True)
